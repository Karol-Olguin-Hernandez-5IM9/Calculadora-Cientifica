...
public class Calculadora extends JFrame {
	...
	public Calculadora() {
		super();
		setSize(250, 300);
		setTitle("Calculadora Cientifica Olguin Hernández Karol 5IM9");
		...
		panelOperaciones.setLayout(new GridLayout(10, 1));
		...
		nuevoBotonOperacion("CE");
                nuevoBotonOperacion("Cubo");
                nuevoBotonOperacion("abs");
                nuevoBotonOperacion("Arcsen");
	...
	private void calcularResultado() {
		if (operacion.equals("+")) {
			...
			resultado *= new Double(pantalla.getText());
		} else if (operacion.equals("Arcsen")) {
			...
			resultado= Math.getExponent(new Double(pantalla.getText()));
		}
